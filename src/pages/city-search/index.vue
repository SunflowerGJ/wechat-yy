  ...
  <div class="container">
    ...
    <div class="history" v-show="!searchData">
      ...
      <div class="history__tags">
        <span class="history__tag">北京</span>
        <span class="history__tag">北京</span>
        <span class="history__tag">北京</span>
      </div> 
    </div>
    <div class="search-mian" v-show="searchData && (searchData.length > 0)">
      ...
      <div class="history__tags">
        <span class="history__tag" v-for="(item,index) in searchData" :index="index" :key="index">{{item.shortname}}</span>
      </div> 
    </div>
    <div class="search-mian" v-show="searchData && (searchData.length === 0)">
      <div class="history__title">
