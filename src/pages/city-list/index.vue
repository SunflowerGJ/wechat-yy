<template>
  <div class="container">
    ...
    <div class="cities">
      ...
      <div class="cities__tags">
        <span class="cities__tag" v-for="(item,index) in recommend" :index="index" :key="index">{{item.shortname}}</span>
      </div>
    </div>
    <div class="cities" >
      <block v-for="(item,index) in cities" :index="index" :key="index">
        ...
        <div class="cities__tags">
          <span class="cities__tag" v-for="(tItem,tIndex) in item[1]" :index="tIndex" :key="tIndex">{{tItem.shortname}}</span>
        </div>
      </block>
    </div>
  </div>
