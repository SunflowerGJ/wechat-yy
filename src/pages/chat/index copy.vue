  ...
  <div class='chating-wrapper' catchtap='chatingWrapperClick'>
   ...
   <div class='record-wrapper' id="recordWrapper">
    <div v-for="message in messageArr" :key="message.time">
      ...
      <div v-if="message.sendOrReceive == 'send'" :class='message.sendOrReceive == "send" ? "record-chatting-item self" : ""' style='justify-content: {{message.type === "tip" || message.type === "notification" ? "center" : "flex-end"}}' :data-message="message" @longpress='showEditorMenu'>
      ...
      <!-- <div v-if="message.sendOrReceive == 'receive'" :class='message.sendOrReceive == "receive" ? "record-chatting-item other" : ""' style='justify-content: {{message.type === "tip" || message.type === "notification" ? "center" : "flex-start"}}' :data-message="message"  @longpress='showEditorMenu'>
