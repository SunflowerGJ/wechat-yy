 ...
 */
export const generateFingerGuessImageFile= (value)=> {
  let file = {
    w: 50,
    h: 50,
    url: ''
 ...
 */
export const clickLogoJumpToCard =(friendsCard, account, isPush)=> {
  let app = getApp()
 ...
 */
export const getFormatFriendList =(friendCard, defaultUserLogo, excludeList)=> {
 ...
 * 计算多人情况下推拉流组件位置以及宽高
 */
export const calculateMeetingPosition =(newUserList = [], oldUserList = [], config)=> {
  config = config || {}
...
export const dealMsg= (msg, store, app)=> {
